...
function VanitiesProjects() {
    ...
    useEffect(() => {
        const fetchProject = async () => {
            try {
                const response = await axios.get(`https://croucher-woodshop-final.herokuapp.com/api/vanities?populate=*&id=${id}`);
...
export default VanitiesProjects;