...
function WoodTurningProjects() {
    ...
    useEffect(() => {
        const fetchProject = async () => {
            try {
                const response = await axios.get(`https://croucher-woodshop-final.herokuapp.com/api/wood-turnings?populate=*&id=${id}`);
...
export default WoodTurningProjects;