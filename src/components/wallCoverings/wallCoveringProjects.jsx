...
function WallCoveringProject() {
    ...
    useEffect(() => {
        const fetchProject = async () => {
            try {
                const response = await axios.get(`https://croucher-woodshop-final.herokuapp.com/api/wall-coverings?populate=*&id=${id}`);
...
export default WallCoveringProject;